...
public class ColaPedidos {
    ...
    public Pedido dequeue() {
        ...
        System.out.println(" Pedido #" + pedidoDespachado.getIdPedido() + " despachado al motorizado.");
    ...
    public void front() {
        if (isEmpty()) {
            ...
            System.out.println("El próximo pedido a despachar es el " + frente.getPedidoActual().getIdPedido());
        }
    }
}